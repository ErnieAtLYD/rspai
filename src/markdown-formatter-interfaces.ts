...
export type CalloutType = 'note' | 'tip' | 'warning' | 'error' | 'success' | 'info' | 'quote';

// Export format types
export type ExportFormat = 'markdown' | 'html' | 'pdf' | 'docx' | 'plain-text' | 'json';
...
export interface ValidationWarning {
  type: 'style' | 'accessibility' | 'performance' | 'compatibility' | 'syntax' | 'structure';
  message: string;
  suggestion?: string;
}
